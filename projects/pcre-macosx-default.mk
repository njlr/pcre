...
$(CONFIG)/obj/pcre_chartables.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/pcre_chartables.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_chartables.c
...
$(CONFIG)/obj/pcre_compile.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/pcre_compile.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_compile.c
...
$(CONFIG)/obj/pcre_exec.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/pcre_exec.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_exec.c
...
$(CONFIG)/obj/pcre_globals.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/pcre_globals.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_globals.c
...
$(CONFIG)/obj/pcre_newline.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/pcre_newline.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_newline.c
...
$(CONFIG)/obj/pcre_ord2utf8.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/pcre_ord2utf8.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_ord2utf8.c
...
$(CONFIG)/obj/pcre_tables.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/pcre_tables.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_tables.c
...
$(CONFIG)/obj/pcre_try_flipped.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/pcre_try_flipped.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_try_flipped.c
...
$(CONFIG)/obj/pcre_ucp_searchfuncs.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/pcre_ucp_searchfuncs.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_ucp_searchfuncs.c
...
$(CONFIG)/obj/pcre_valid_utf8.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/pcre_valid_utf8.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_valid_utf8.c
...
$(CONFIG)/obj/pcre_xclass.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/pcre_xclass.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_xclass.c
...
$(CONFIG)/bin/libpcre.dylib: $(DEPS_20)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libpcre.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libpcre.dylib -compatibility_version 1.0.2 -current_version 1.0.2 "$(CONFIG)/obj/pcre_chartables.o" "$(CONFIG)/obj/pcre_compile.o" "$(CONFIG)/obj/pcre_exec.o" "$(CONFIG)/obj/pcre_globals.o" "$(CONFIG)/obj/pcre_newline.o" "$(CONFIG)/obj/pcre_ord2utf8.o" "$(CONFIG)/obj/pcre_tables.o" "$(CONFIG)/obj/pcre_try_flipped.o" "$(CONFIG)/obj/pcre_ucp_searchfuncs.o" "$(CONFIG)/obj/pcre_valid_utf8.o" "$(CONFIG)/obj/pcre_xclass.o" $(LIBS) 
