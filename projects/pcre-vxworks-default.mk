...
TARGETS               += build/$(CONFIG)/bin/libpcre.out
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/pcre-vxworks-default-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/pcre-vxworks-default-me.h >/dev/null ; then\
		cp projects/pcre-vxworks-default-me.h $(BUILD)/inc/me.h  ; \
	fi; true
...
build/$(CONFIG)/bin/libpcre.out: $(DEPS_19)
	@echo '      [Link] build/$(CONFIG)/bin/libpcre.out'
	$(CC) -r -o build/$(CONFIG)/bin/libpcre.out $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/pcre_chartables.o" "build/$(CONFIG)/obj/pcre_compile.o" "build/$(CONFIG)/obj/pcre_exec.o" "build/$(CONFIG)/obj/pcre_globals.o" "build/$(CONFIG)/obj/pcre_newline.o" "build/$(CONFIG)/obj/pcre_ord2utf8.o" "build/$(CONFIG)/obj/pcre_tables.o" "build/$(CONFIG)/obj/pcre_try_flipped.o" "build/$(CONFIG)/obj/pcre_ucp_searchfuncs.o" "build/$(CONFIG)/obj/pcre_valid_utf8.o" "build/$(CONFIG)/obj/pcre_xclass.o" $(LIBS) 
