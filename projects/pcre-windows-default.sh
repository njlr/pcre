#
#   pcre-windows-default.sh -- Build It Shell Script to build PCRE Library
#
...
DFLAGS="-D_REENTRANT -D_MT -DBIT_FEATURE_PCRE=1"
IFLAGS="-I${CONFIG}/inc"
...
"${LD}" -dll -out:${CONFIG}/bin/libpcre.dll -entry:_DllMainCRTStartup@12 ${LDFLAGS} ${LIBPATHS} ${CONFIG}/obj/pcre_chartables.obj ${CONFIG}/obj/pcre_compile.obj ${CONFIG}/obj/pcre_exec.obj ${CONFIG}/obj/pcre_globals.obj ${CONFIG}/obj/pcre_newline.obj ${CONFIG}/obj/pcre_ord2utf8.obj ${CONFIG}/obj/pcre_tables.obj ${CONFIG}/obj/pcre_try_flipped.obj ${CONFIG}/obj/pcre_ucp_searchfuncs.obj ${CONFIG}/obj/pcre_valid_utf8.obj ${CONFIG}/obj/pcre_xclass.obj ${LIBS}
