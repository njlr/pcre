...
prep:
	...
	@[ ! -f $(CONFIG)/inc/me.h ] && cp projects/pcre-linux-default-me.h $(CONFIG)/inc/me.h ; true
	@if ! diff $(CONFIG)/inc/me.h projects/pcre-linux-default-me.h >/dev/null ; then\
		cp projects/pcre-linux-default-me.h $(CONFIG)/inc/me.h  ; \
	fi; true
