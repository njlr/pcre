...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/pcre-linux-default-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/pcre-linux-default-me.h >/dev/null ; then\
		cp projects/pcre-linux-default-me.h $(BUILD)/inc/me.h  ; \
	fi; true
...
build/$(CONFIG)/obj/pcre_chartables.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_chartables.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_chartables.c
...
build/$(CONFIG)/obj/pcre_compile.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_compile.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_compile.c
...
build/$(CONFIG)/obj/pcre_exec.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_exec.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_exec.c
...
build/$(CONFIG)/obj/pcre_globals.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_globals.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_globals.c
...
build/$(CONFIG)/obj/pcre_newline.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_newline.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_newline.c
...
build/$(CONFIG)/obj/pcre_ord2utf8.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_ord2utf8.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_ord2utf8.c
...
build/$(CONFIG)/obj/pcre_tables.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_tables.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_tables.c
...
build/$(CONFIG)/obj/pcre_try_flipped.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_try_flipped.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_try_flipped.c
...
build/$(CONFIG)/obj/pcre_ucp_searchfuncs.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_ucp_searchfuncs.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_ucp_searchfuncs.c
...
build/$(CONFIG)/obj/pcre_valid_utf8.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_valid_utf8.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_valid_utf8.c
...
build/$(CONFIG)/obj/pcre_xclass.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_xclass.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_xclass.c
