...
TARGETS               += build/$(CONFIG)/bin/libpcre.so
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/pcre-freebsd-default-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/pcre-freebsd-default-me.h >/dev/null ; then\
		cp projects/pcre-freebsd-default-me.h $(BUILD)/inc/me.h  ; \
	fi; true
...
build/$(CONFIG)/obj/pcre_chartables.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_chartables.o $(LDFLAGS) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_chartables.c
...
build/$(CONFIG)/obj/pcre_compile.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_compile.o $(LDFLAGS) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_compile.c
...
build/$(CONFIG)/obj/pcre_exec.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_exec.o $(LDFLAGS) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_exec.c
...
build/$(CONFIG)/obj/pcre_globals.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_globals.o $(LDFLAGS) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_globals.c
...
build/$(CONFIG)/obj/pcre_newline.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_newline.o $(LDFLAGS) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_newline.c
...
build/$(CONFIG)/obj/pcre_ord2utf8.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_ord2utf8.o $(LDFLAGS) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_ord2utf8.c
...
build/$(CONFIG)/obj/pcre_tables.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_tables.o $(LDFLAGS) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_tables.c
...
build/$(CONFIG)/obj/pcre_try_flipped.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_try_flipped.o $(LDFLAGS) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_try_flipped.c
...
build/$(CONFIG)/obj/pcre_ucp_searchfuncs.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_ucp_searchfuncs.o $(LDFLAGS) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_ucp_searchfuncs.c
...
build/$(CONFIG)/obj/pcre_valid_utf8.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_valid_utf8.o $(LDFLAGS) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_valid_utf8.c
...
build/$(CONFIG)/obj/pcre_xclass.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pcre_xclass.o $(LDFLAGS) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pcre_xclass.c
...
build/$(CONFIG)/bin/libpcre.so: $(DEPS_19)
	@echo '      [Link] build/$(CONFIG)/bin/libpcre.so'
	$(CC) -shared -o build/$(CONFIG)/bin/libpcre.so $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/pcre_chartables.o" "build/$(CONFIG)/obj/pcre_compile.o" "build/$(CONFIG)/obj/pcre_exec.o" "build/$(CONFIG)/obj/pcre_globals.o" "build/$(CONFIG)/obj/pcre_newline.o" "build/$(CONFIG)/obj/pcre_ord2utf8.o" "build/$(CONFIG)/obj/pcre_tables.o" "build/$(CONFIG)/obj/pcre_try_flipped.o" "build/$(CONFIG)/obj/pcre_ucp_searchfuncs.o" "build/$(CONFIG)/obj/pcre_valid_utf8.o" "build/$(CONFIG)/obj/pcre_xclass.o" $(LIBS) 
